...
const Medoc = () => (
  <>
    ...
    <p>
      Malgré les polémiques concernant le nucléaire et la radioactivté, de
      nombreux avantages sont peu à peu découverts. La médecine fait partie des
      domaines qui en bénéficient pleinement.
    </p>
    <h3>Radiothérapie</h3>
    <p>
      ...
      mais est également utilisée pour traiter d'autres affections médicales
      telles que des troubles inflammatoires ou des maladies vasculaires. Cette
      technique de traitement, bien qu'ancienne, est encore très largement
    ...
    <h3>Ambulances de Marie Curie</h3>
    <ImageBox
      side="right"
    ...
    />
    <p>
      À l'aube de la première Guerre mondiale, Marie Curie a reçu une
      autorisation de la part du ministère de l'armée afin de mettre en place
    ...
    <p>
      Marie Curie ne se limita pas seulement à la détection des blessures. Elle
    ...
    <h3>Médecine nucléaire</h3>
    <DefinitionBox
      side="left"
      title="Tomographie par émission de positions"
